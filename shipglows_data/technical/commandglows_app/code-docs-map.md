...
| `lib/features/pinning/domain/**` | Provider-neutral pin references, repository API, and independent pin-window host contract | `shipglows_data/technical/commandglows_app/architecture.md`; `shipglows_data/workflow/specs/reusable-pin-core-and-independent-window-contract.md` | `flutter analyze`; source-boundary review | Pin identity/lifecycle, source reference semantics, or per-pin detached-window host contract changes; native windows, UI, and source adapters require a separately scoped integration |
...
| `android/app/src/main/kotlin/com/commandglows_app/commandglows_app/ime/CommandGlowsKeyboardView.kt`, `android/app/src/main/kotlin/com/commandglows_app/commandglows_app/ime/KeyboardLongPressSwipePolicy.kt` | IME gesture dispatch and swipe arbitration | `shipglows_data/technical/commandglows_app/ime-gesture-model.md` | `flutter analyze` locally; targeted source comment review; Blacksmith/GitHub Actions for native compile/package proof when behavior changes | Long-press swipe dispatch, Ctrl swipe launch, target corner selection, space slider arbitration, or gesture hover/release behavior changes |
...
| `lib/features/keyboard/presentation/keyboard_theme_studio_screen.dart`, `lib/features/keyboard/domain/keyboard_models.dart`, `lib/features/keyboard/domain/keyboard_theme_validation.dart`, `android/app/src/main/kotlin/com/commandglows_app/commandglows_app/ime/KeyboardThemeModels.kt`, `android/app/src/main/kotlin/com/commandglows_app/commandglows_app/ime/KeyboardPressEffects.kt` | Keyboard Theme Studio + gesture slots | `docs/technical/android-native.md`; `docs/COMPONENTS.md` | `flutter test test/keyboard_theme_studio_screen_test.dart test/keyboard_theme_validation_test.dart` | Theme contract, gesture slot contract (directional + corners), preset catalog, JSON import/export, native renderer, background import/downsample path, preview/simulation, press effects, validation, or MethodChannel changes |
