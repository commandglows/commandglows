...
depends_on:
  ...
  - artifact: "shipglows_data/technical/commandglows_app/guidelines.md"
    artifact_version: "1.0.1"
    required_status: "reviewed"
supersedes: []
evidence:
  ...
  - "CommandGlows keyboard sync controller already implements account-safe seed, hydrate, conflict, queue and account-switch patterns."
...
This playbook is the reusable doctrine for any CommandGlows chantier that turns local-first data into account-backed cloud data.
...
- `shipglows_data/technical/commandglows_app/local-cloud-sync-playbook.md`
- `shipglows_data/technical/commandglows_app/flutter-local-cloud-sync.md`
- `shipglows_data/workflow/specs/*sync*.md`
- `shipglows_data/workflow/verification/*sync*.md`

## Entrypoints

- Spec first: `shipglows_data/workflow/specs/app-local-to-cloud-data-promotion-merge.md`
- Flutter implementation guide: `shipglows_data/technical/commandglows_app/flutter-local-cloud-sync.md`
- Existing code pattern: `commandglows_app/lib/features/keyboard/application/keyboard_sync_controller.dart`
...
flutter analyze
flutter test
python3 /home/claude/shipglows/tools/shipglows_metadata_lint.py shipglows_data/technical/commandglows_app/local-cloud-sync-playbook.md
```
...
Update this playbook whenever CommandGlows adds a new sync domain, changes account-seeding policy, changes conflict-resolution surfaces, changes secret policy, or changes the proof required for reinstall/relogin recovery.
