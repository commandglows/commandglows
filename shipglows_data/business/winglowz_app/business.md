...
evidence:
  ...
  - "docs/API.md"
  - "README.md"
  - "shipglows_data/workflow/audits/2026-06-10-winglowz-platform-parity.md"
...
| Clavier Android natif WinGlows | target-reviewed | `shipglows_data/workflow/specs/android-ime-winglowz_app-keyboard.md` |
