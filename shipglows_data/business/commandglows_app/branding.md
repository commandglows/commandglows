...
- **Nom légal/technique** : CommandGlows.
- **Wordmark public** : CMDglows — forme courte, compacte et immédiatement associée à la commande clavier.
...
CMDglows reste visuellement relié à l'écosystème CommandGlows, avec une identité orientée produit utilitaire : rapide, lisible, orientée action. Les identifiants techniques restent inchangés.
...
- Les plateformes non Android ne doivent pas recevoir de promesse de clavier système CommandGlows. Elles peuvent recevoir une promesse d'overlay/quick action uniquement quand le host natif, l'adaptation ou la limitation dégradée est implémenté, testé et documenté.
...
- "Clavier CommandGlows disponible uniquement sur Android."
