...
linked_systems:
  - "winglowz_site"
  - "shipglows_data/workflow/specs/temu-vinted-listing-assistant.md"
  - "shipglows_data/workflow/research/2026-06-19-marketplaces-api-cli-automation.md"
supersedes: []
evidence:
...
- La spec reste dans `shipglows_data/workflow/specs/` pour préserver la convention chantier.
