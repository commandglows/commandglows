...
depends_on:
  ...
  - artifact: "shipglows_data/technical/architecture.md"
    ...
    required_status: "reviewed"
  - artifact: "shipglows_data/technical/winglowz_app/guidelines.md"
    artifact_version: "1.0.1"
    required_status: "reviewed"
supersedes: []
evidence:
  - "python3 /home/claude/shipglows/tools/design_system_drift_check.py --format markdown --warn-only --max-findings 5000"
  - "Excluding generated .vercel/output artifacts: 422 findings still actionable"
  - "Canonique visuel recommandé dans `shipglows_data/technical/design-system-authority.md`"
...
- Documentation de chantier dans `shipglows_data/technical/design-system-authority.md` et `shipglows_data/technical/guidelines.md` si nécessaire.
...
- Contrat technique visuel canonique : `shipglows_data/technical/design-system-authority.md`.
- Contrat produit/branding : `shipglows_data/business/branding.md`.
- Contraintes techniques : `shipglows_data/technical/guidelines.md`.
- Contexte Flutter App : `shipglows_data/technical/winglowz_app/guidelines.md`.
- Contrat d’architecture : `shipglows_data/technical/architecture.md`.
- Outil de contrôle qualité : `/home/claude/shipglows/tools/design_system_drift_check.py`.
...
- checklist_path: `shipglows_data/workflow/test-checklists/winglowz-token-hardening-and-visual-standardization.md`.
...
- `shipglows_data/technical/design-system-authority.md` : devient le garde-fou opérationnel de design-system.
- `shipglows_data/workflow/TASKS.md` : tâches résiduelles de dette visuelle si des exceptions temporaires restent ouvertes.
- Documentation utilisateur et brand pages may need alignment if copy around theming/help text changes.

## Documentation Coherence

- Mettre à jour, si besoin, `shipglows_data/technical/design-system-authority.md` avec la liste finale des exceptions acceptées.
- Mettre à jour `shipglows_data/technical/guidelines.md` si de nouvelles règles de migration ou de guardrails sont promulguées.
...
- [ ] Tâche 1: Verrouiller la doctrine d’autorité visuelle
  - Fichiers: `shipglows_data/technical/design-system-authority.md`, `shipglows_data/technical/guidelines.md`
...
- [ ] Tâche 4: Réduire les valeurs littérales dans composants Flutter partagés
  ...
  - Depends on: Tâche 2.
  - Validate with: `python3 /home/claude/shipglows/tools/design_system_drift_check.py --changed --format markdown`.
...
- [ ] Tâche 8: Mettre en place le contrôle de preuve visuelle
  - Fichiers: `shipglows_data/workflow/test-checklists/winglowz-token-hardening-and-visual-standardization.md`, `shipglows_data/workflow/audits/` si nécessaire
...
- [ ] Tâche 9: Re-lancer l’audit de drift avant fermeture
  - Fichiers: `shipglows_data/workflow/audits/2026-06-11-winglowz-design-token-audit.md` + nouveaux outputs de drift.
  - Action: obtenir un nouveau baseline, viser une chute significative des findings non-justifiés.
  - Depends on: Tâches 2-8.
  - Validate with: `python3 /home/claude/shipglows/tools/design_system_drift_check.py --format markdown --warn-only --max-findings 5000` et comparaison des KPI.

- [ ] Tâche 10: Finaliser la doc de sortie chantier
  - Fichiers: cette spec, `shipglows_data/technical/design-system-authority.md`
...
- [ ] CA-6: `shipglows_data/technical/design-system-authority.md` reflects the enforcement rules and allowed exception list.
...
- Lire d’abord: `shipglows_data/technical/design-system-authority.md`, `shipglows_data/workflow/audits/2026-06-11-winglowz-design-token-audit.md`, `winglowz_app/lib/core/theme/winglowz_theme_tokens.dart`, `winglowz_site/src/assets/styles/global.css`.
