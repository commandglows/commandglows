...
## Dependencies
- Existing Theme Studio spec: `shipglows_data/workflow/specs/keyboard-theme-studio.md`.
...
- Update `shipglows_data/workflow/specs/keyboard-theme-studio.md` or implementation notes to mention the follow-up relief layer.
