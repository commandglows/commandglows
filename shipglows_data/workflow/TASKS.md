...
🔄 [Suite] task: Harmoniser le commerce, l'identité et les entitlements autour du ledger Convex canonique, avec CommunityGlows Windows comme premier pilote complet | status: in progress | area: unified-commerce-entitlements | id: unified-suite-commerce-entitlements | impact: critical | effort: large | authority: `C:\Users\Diane\ShipGlows\shipglows\shipglows_data\workflow\specs\unified-suite-commercial-entitlement-and-stripe.md` v1.3.0 + plan opérateur validé le 2026-09-06 | current_slice: transitions Stripe centrales ciblées par achat, ordre des événements et reprise `pending_review` implémentés localement | local_evidence: 12 tests Convex ciblés passent | remaining: isolation complète, identité/recovery, AppSumo, CommunityGlows Windows, miroirs et adaptateurs portfolio; aucune preuve hosted/provider/native revendiquée
