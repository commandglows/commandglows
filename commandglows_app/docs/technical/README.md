...
supersedes: []
evidence:
  - "Bootstrapped for shipglows_data/workflow/specs/android-ime-commandglows_app-keyboard.md execution."
next_review: "2026-06-04"
next_step: "/sf-docs technical audit"
---

# Technical Docs — CommandGlows
...
- `docs/technical/suite-authentication.md`: pointer to the canonical CommandGlows
