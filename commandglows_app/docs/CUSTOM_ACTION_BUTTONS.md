...
depends_on:
  ...
  - "shipglows_data/technical/commandglows_app/context-function-tree.md"
evidence:
  - "commandglows_app/lib/features/custom_action_buttons/domain/custom_action_buttons.dart"
  - "commandglows_app/lib/features/snippets/presentation/custom_action_buttons_panel.dart"
  - "commandglows_app/lib/features/custom_action_buttons/application/custom_action_button_runner.dart"
supersedes: []
next_step: "/sf-docs update"
---

# Boutons personnalisés et actions CommandGlows
...
- Je veux réutiliser une expression clavier CommandGlows déjà connue.
...
- La synchronisation Android passe par une projection IME filtrée : texte, expression clavier CommandGlows, presse-papiers et média peuvent être envoyés au clavier; les séquences desktop et macros restent hors IME.
...
- `insert text`
- `keyboard expression` (langage CommandGlows)
...
Expression textuelle déjà utilisée côté clavier Android (format d’expression CommandGlows).
