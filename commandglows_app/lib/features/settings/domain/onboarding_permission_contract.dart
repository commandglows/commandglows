...
const _stepDefinitions = <OnboardingStepDefinition>[
  OnboardingStepDefinition(
    ...
    title: 'Clavier CMDglows keyboard',
    description:
        'Active et sélectionne CMDglows keyboard comme clavier Android.',
    why:
  ...
  OnboardingStepDefinition(
    ...
    whereToFind: 'CMDglows → Settings → Keyboard clipboard sync intent',
  ),
  OnboardingStepDefinition(
    ...
    whereToFind:
        'Réglages Android → Applications → CMDglows → Autorisations → Microphone',
  ),
  OnboardingStepDefinition(
