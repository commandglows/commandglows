...
- `commandglows_app/pubspec.yaml` is the canonical Flutter SDK source of truth.
...
- `commandglows_app/docs/CUSTOM_ACTION_BUTTONS.md` documente la page `Actions`, la barre d’action personnalisable, la compatibilité IME Android et les limites desktop.
- `commandglows_app/docs/PLATFORM_BEHAVIOR.md` couvre les limites par plateforme et le contrat hôte.
- `commandglows_app/docs/COMPONENTS.md` inclut l’inventaire des composants `Actions`, `Snippets` et clavier Android.
