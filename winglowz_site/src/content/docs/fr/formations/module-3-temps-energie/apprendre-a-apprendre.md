...
La leçon classique d'Ebbinghaus<sup>[1](#concept-forgetting-curve)</sup> reste valable : sans réactivation, une grande partie de ce que tu apprends disparaît vite.
...
Le rappel actif<sup>[2](#concept-retrieval-practice)</sup> est le cœur du système.
...
La répétition espacée<sup>[3](#concept-spaced-repetition)</sup> n'est pas magique. Elle est simplement logique : revoir une information juste avant qu'elle ne disparaisse.
...
Le chunking<sup>[4](#concept-chunking)</sup> consiste à transformer des éléments isolés en unités mentales plus stables.
...
<a id="ref-forgetting-curve"></a>1) **Courbe de l'oubli (forgetting curve)** — John T. Murre & Joeri Dros (2015), *Replication and Analysis of Ebbinghaus' Forgetting Curve* — [PLOS ONE](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0120644)

<a id="ref-testing-effect"></a>2) **Effet de test / rappel actif (testing effect / retrieval practice)** — Henry L. Roediger III & Jeffrey D. Karpicke (2006), *Test-Enhanced Learning: Taking Memory Tests Improves Long-Term Retention* — [Psychological Science (DOI)](https://doi.org/10.1111/j.1467-9280.2006.01693.x)

<a id="ref-spaced-repetition"></a>3) **Répétition espacée (distributed practice)** — Nicholas J. Cepeda et al. (2006), *Distributed Practice in Verbal Recall Tasks: A Review and Quantitative Synthesis* — [Psychological Bulletin (DOI)](https://doi.org/10.1037/0033-2909.132.3.354)

<a id="ref-learning-techniques"></a>4) **Techniques d'apprentissage efficaces (synthèse)** — John Dunlosky et al. (2013), *Improving Students' Learning With Effective Learning Techniques: Promising Directions From Cognitive and Educational Psychology* — [Psychological Science in the Public Interest (DOI)](https://doi.org/10.1177/1529100612453266)

<a id="ref-chunking-wm"></a>5) **Chunking / capacité de mémoire de travail** — George A. Miller (1956), *The Magical Number Seven, Plus or Minus Two: Some Limits on Our Capacity for Processing Information* — [APA PsycNet](https://psycnet.apa.org/record/1956-01522-000)

### Approfondissement des concepts techniques

<a id="concept-forgetting-curve"></a>#### Courbe de l'oubli (forgetting curve)
Sans réactivation, la probabilité de rappel décroît rapidement après l'exposition initiale. Le point opérationnel est simple : si tu veux garder, tu dois planifier des retours.
Source scientifique : [1](#ref-forgetting-curve)

<a id="concept-retrieval-practice"></a>#### Rappel actif (retrieval practice)
Se tester (récupérer l'information de mémoire) renforce la rétention plus que relire passivement. C'est l'une des techniques les plus robustes en psychologie cognitive pour améliorer la mémoire à long terme.
Source scientifique : [2](#ref-testing-effect)

<a id="concept-spaced-repetition"></a>#### Répétition espacée (spaced repetition)
Espacer les révisions profite au rappel durable parce que chaque récupération se fait avec un effort contrôlé, au bon moment. Ce n'est pas la quantité de relectures qui compte, mais le timing des rappels.
Source scientifique : [3](#ref-spaced-repetition)

<a id="concept-chunking"></a>#### Chunking
Le chunking consiste à regrouper des éléments en unités plus stables, ce qui réduit la charge sur la mémoire de travail et améliore la compréhension. Concrètement : patterns, catégories, exemples et reformulation construisent ces unités.
