...
| Réflexe nocif | Remplacement plus utile |
|---|---|
| scroll compulsif | marche courte, lecture, capture d'idée |
| plainte automatique | gratitude, reformulation, action suivante |
| overthinking | plus petite action visible |
| vérification constante du téléphone | créneaux dédiés, téléphone hors de portée |
...
- **[Habitica](https://habitica.com/static/home)** si la gamification te motive vraiment
- **[Polar Habits](https://polarhabits.com/)** si tu veux suivre sans obsession du streak parfait
- **[Habits Garden](https://habitsgarden.com/)** si une visualisation ludique t'aide à rester engagé
...
- mémo vocal matinal
- revue hebdomadaire
- **[Bullet Journal](https://bulletjournal.com/)** si tu préfères un système papier simple et flexible
...
Choisis une seule habitude que tu veux rendre plus stable et écris :

1. la version minimale de cette habitude
2. le déclencheur exact
3. ce qui doit être préparé dans l'environnement
4. le remplacement prévu si un mauvais réflexe prend sa place
5. la version de reprise après un jour raté
