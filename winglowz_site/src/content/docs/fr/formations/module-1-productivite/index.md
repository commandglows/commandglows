...
description: "La productivité comme système de choix, d'attention, d'énergie et d'exécution, pas comme culte de la vitesse."
sidebar:
  label: "Introduction"
  order: 1
---
...
Avant de continuer la formation, écris en une phrase :

1. ce que tu veux vraiment rendre plus facile
2. ce qui te fait aujourd'hui perdre le plus d'attention
3. si ton vrai problème est surtout un problème de choix, d'environnement, d'énergie ou d'exécution
