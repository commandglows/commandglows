...
const pages: Record<ScriptPageKey, Record<Language, ScriptInstallPageContent>> = {
	...
	shipglows: {
		en: {
			...
			command: 'curl -fsSL https://www.winflowz.com/shipglows-script | sh',
			rawScriptUrl: '/shipglows-script',
			githubUrl: 'https://github.com/dianedef/ShipGlows',
			...
			linksTitle: 'Useful links',
			links: [
				{ label: 'ShipGlows public docs', href: 'https://github.com/dianedef/ShipGlows' },
			...
			installVariants: [
				{
					...
					platform: 'unix',
					mode: 'local',
					command: 'curl -fsSL https://www.winflowz.com/shipglows-script | SHIPGLOWS_INSTALL_MODE=local sh',
				...
				},
				{
					...
					platform: 'unix',
					mode: 'full',
					command: 'curl -fsSL https://www.winflowz.com/shipglows-script | sudo env SHIPGLOWS_INSTALL_MODE=full sh',
		...
		fr: {
			...
			linksTitle: 'Liens utiles',
			links: [
				{ label: 'Docs publiques ShipGlows', href: 'https://github.com/dianedef/ShipGlows' },
