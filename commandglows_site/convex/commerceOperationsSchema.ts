...
export const commerceOperationsTables = {
  commerceIncidents: defineTable({
    ...
    providerEventId: v.string(), providerAccountId: v.optional(v.string()), productId: v.string(), sourceRef: v.optional(v.string()),
    ...
    .index('by_scoped_provider_event', ['environment', 'providerAccountId', 'providerEventId'])
