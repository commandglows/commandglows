  ...
  const content =
    lang === 'fr'
      ? {
          subject:
            source === 'lead-magnet'
              ? 'Bienvenue chez CMDglows — votre prochaine etape'
              : 'Bienvenue chez CMDglows',
          heading: 'Bienvenue chez CMDglows',
          intro:
            "Vous etes bien inscrit(e). Le point de depart le plus utile pour comprendre l'approche CMDglows est maintenant la page dediee a la formation Windows.",
          body:
