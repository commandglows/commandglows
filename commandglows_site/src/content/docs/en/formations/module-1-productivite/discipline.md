...
- **[Habitica](https://habitica.com/static/home)** if gamification genuinely keeps you engaged
- **[Polar Habits](https://polarhabits.com/)** if you want tracking without obsession over perfect streaks
- **[Habits Garden](https://habitsgarden.com/)** if a playful visual system helps you stay engaged
...
- morning voice memo
- weekly review
- **[Bullet Journal](https://bulletjournal.com/)** if you prefer a simple flexible paper system
...
Choose one habit you want to make more stable and write down:

1. the minimum version of the habit
2. the exact cue
3. what must be prepared in the environment
4. the replacement planned if a bad reflex takes its place
5. the restart version after a missed day
